...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RadioButton radio_en = (RadioButton) findViewById(R.id.radio_en);
        RadioButton radio_vn = (RadioButton) findViewById(R.id.radio_vn);
    ...
    private Locale getUserSelectedLanguage() {
        ...
        else if (checkedRadioId == R.id.radio_vn) {
